...
export const TIMEZONES = [].concat(
	timezones_Africa,
	timezones_America,
	timezones_Antarctica,
	timezones_Arctic,
	timezones_Asia,
	timezones_Atlantic,
	timezones_Australia,
...
export const TIMEZONES_LABELS = fromPairs( map( TIMEZONES, ( { label, value } ) => ( [ value, label ] ) ) );
